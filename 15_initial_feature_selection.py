...
df = pd.read_excel("d:/USveri/ALL_FEATURES_WITH_KUME_DENEME.xlsx")
...
selector = SelectFromModel(model_fs, threshold=0.01, prefit=True)
...
selected_df.to_excel("D:/USveri/US_xgboost_selected_features_fcm.xlsx", index=False)

# Seçilen özellik adlarını ayrı dosyaya yazılnası
pd.Series(selected_cols).to_excel(
    "D:/USveri/US_xgboost_selected_feature_names_fcm.xlsx",
    index=False,
